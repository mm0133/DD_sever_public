...
urlpatterns = [
    ...
    path("question_to_manager/", views.QuestionToManagerView.as_view()),  # get, post
    path("question_to_manager/private/", views.get_privateQuestionToManager),  # get
    path("question_to_manager/public/", views.get_publicQuestionToManager),  # get
    path("question_to_manager/my/", views.get_MyQuestionToManager),  # get
